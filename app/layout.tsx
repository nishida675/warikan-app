...
const SITE_URL =
  process.env.NEXT_PUBLIC_SITE_URL || "https://warikanapp.vercel.app/";
const SITE_NAME = "割り勘アプリ";
const SITE_DESCRIPTION =
  "面倒な割り勘計算を数秒で完了。会員登録不要・アプリインストール不要。旅行、BBQ、飲み会、イベントの立替費用をURL共有だけでスマートに精算できる無料のWebアプリです。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "旅行や飲み会の面倒な精算を、リンクを送るだけで解決。誰が誰にいくら払うか自動計算します。",
    url: SITE_URL,
    siteName: SITE_NAME,
    locale: "ja_JP",
    type: "website",
